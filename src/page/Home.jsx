...
const Home = () => {
  return (
    <>
    <main className='max-w-full h-screen flex justify-center items-center flex-col font-poppins text-blckgray bg-whiteez'>
       <h1 className='p-2 text-7xl mb-4'>FINAL PROJECT</h1>
       <h2 className='p-2 text-3xl mb-4'>Web Services and API Integration</h2>
       <div className='flex gap-6 p-2 text-xl mb-20'>
