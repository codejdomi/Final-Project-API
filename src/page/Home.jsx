...
const Home = () => {
  return (
    ...
    <main className='max-w-full h-screen flex justify-center items-center flex-col text-blckgray bg-whiteez'>
       <h1 className='p-2 lg:text-8xl md:text-5xl text-4xl mb-4'>FINAL PROJECT</h1>
       <h2 className='p-2 lg:text-4xl md:text-5xl text-2xl mb-4'>Web Services and API Integration</h2>
       <div className='flex gap-10 p-2 text-2xl mb-20'>
